...
INSERT INTO menu (menu, slug, path, sort_order) values ('Payment','/finance/payment','Top.Finance.Payment', '290');
INSERT INTO menu (menu, slug, path, sort_order) values ('Payment Entry','/finance/payment','Top.Finance.Payment.Entry','300');

...
[[block name="ContentBody"]]
      <table id="manage-bankcard-datatable" class="data-table table table-striped" style="width:100%">
        <thead>
            <tr>
                <th>Id</th>
                <th>Partner</th>
    ...
    <div class="datatable-action-control-wrapper">
        <div class="checkbox">
            <label><input type="checkbox" value="" id="manage-bankcard-datatable-includeDeleted"> Show deleted records</label>
        </div>
...
[[block name="ModalBody"]]
    ...
    <form class="form" role="form" autocomplete="off"  novalidate="" method="POST" action="" />
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="partner" id="bankcard" required="" ng-model="Data.bankcard.bankcard">
            <div class="invalid-feedback">Please enter partner</div>
        </div>
        <div class="form-group">
            <switch-enabled ng-model="Data.bankcard.enabled" />
        </div>

        <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
            <button type="button" class="btn btn-primary" id="save-bankcard" ng-click="saveBankcard()">Save changes</button>
        </div>
    </form>
[[/block]]